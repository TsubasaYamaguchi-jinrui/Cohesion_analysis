...
# saveRDS(b_no_kin_an2_IT, "data/b_no_kin_an2_IT.rds")
# saveRDS(b_rank_an2_IT, "data/b_rank_an2_IT.rds")

## 読み込み  
b_CSI_IT_an2 <- readRDS("data/b_CSI_IT_an2.rds")
b_no_kin_an2_IT <- readRDS("data/b_no_kin_an2_IT.rds")
...
model_parameters(m_an2_IT_eigen,  ci = 0.95,dispersion = TRUE,
  ...
  mutate(`P left` = c(NA,
                      ...
                      mean(fixef(m_an2_IT_eigen)[3,1] < b_no_kin_an2_IT),
                      mean(fixef(m_an2_IT_eigen)[4,1] < b_rank_an2_IT))) %>% 
  mutate(`P right` = c(NA,
                      mean(fixef(m_an2_IT_eigen)[2,1] > b_CSI_IT_an2),
                      mean(fixef(m_an2_IT_eigen)[3,1] > b_no_kin_an2_IT),
                      mean(fixef(m_an2_IT_eigen)[4,1] > b_rank_an2_IT))) %>% 
