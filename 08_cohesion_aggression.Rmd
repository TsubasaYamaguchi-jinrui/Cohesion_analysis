...
recal_agg_prox_an <- recalculateResiduals(dh_agg_prox_an, group = focal_agg_prox_an$time)

testTemporalAutocorrelation(recal_agg_prox_an, time = unique(focal_agg_prox_an$time))
```
<br/>  
...
recal_agg_prox_an_bf21 <- recalculateResiduals(dh_agg_prox_an_bf21, group = focal_agg_prox_an$time)

testTemporalAutocorrelation(recal_agg_prox_an_bf21, time = unique(focal_agg_prox_an$time))
```
<br/>  
...
recal_agg_prox_es <- recalculateResiduals(dh_agg_prox_es, group = focal_agg_prox_es$time)

testTemporalAutocorrelation(recal_agg_prox_es, time = unique(focal_agg_prox_es$time))
```
<br/>  
...
recal_agg_prox_es_bf21 <- recalculateResiduals(dh_agg_prox_es_bf21, group = focal_agg_prox_es_bf21$time)

testTemporalAutocorrelation(recal_agg_prox_es_bf21, time = unique(focal_agg_prox_es_bf21$time))
```
<br/>  
...
recal_agg_RG_an <- recalculateResiduals(dh_agg_RG_an, group = focal_agg_RG_an$time)

testTemporalAutocorrelation(recal_agg_RG_an, time = unique(focal_agg_RG_an$time))
```
<br/>  
...
recal_agg_RG_an_bf21 <- recalculateResiduals(dh_agg_RG_an_bf21, group = focal_agg_RG_an_bf21$time)

testTemporalAutocorrelation(recal_agg_RG_an_bf21, time = unique(focal_agg_RG_an_bf21$time))
```
<br/>  
...
recal_agg_RG_es <- recalculateResiduals(dh_agg_RG_es, group = focal_agg_RG_es$time)

testTemporalAutocorrelation(recal_agg_RG_es, time = unique(focal_agg_RG_es$time))
```
<br/>  
...
recal_agg_RG_es_bf21 <- recalculateResiduals(dh_agg_RG_es_bf21, group = focal_agg_RG_es_bf21$time)

testTemporalAutocorrelation(recal_agg_RG_es_bf21, time = unique(focal_agg_RG_es_bf21$time))
```
<br/>  
