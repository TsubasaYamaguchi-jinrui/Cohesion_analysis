...
model_parameters(m_prox_an_RG,  ci = 0.95,
                 centrality = "median", ci_method = "eti") %>% 
  filter(Parameter != "sigma") %>% 
  data.frame() %>%
  dplyr::select(1,3,5,6, 7,8) %>% 
...
model_parameters(m_prox_an_RG_bf21,  ci = 0.95,
                 centrality = "median", ci_method = "eti") %>% 
  filter(Parameter != "sigma") %>% 
  data.frame() %>%
  dplyr::select(1,3,5,6, 7,8) %>% 
...
model_parameters(m_prox_nm_RG,  ci = 0.95,
                 centrality = "median", ci_method = "eti") %>% 
  filter(Parameter != "sigma") %>% 
  data.frame() %>%
  dplyr::select(1,3,5,6, 7,8) %>% 
...
model_parameters(m_prox_an_F,  ci = 0.95,
                 centrality = "median", ci_method = "eti") %>% 
  filter(Parameter != "sigma") %>% 
  data.frame() %>%
  dplyr::select(1,3,5,6, 7,8) %>% 
...
model_parameters(m_prox_an_F_bf21,  ci = 0.95,
                 centrality = "median", ci_method = "eti") %>% 
  filter(Parameter != "sigma") %>% 
  data.frame() %>%
  dplyr::select(1,3,5,6, 7,8) %>% 
...
model_parameters(m_prox_nm_F,  ci = 0.95,
                 centrality = "median", ci_method = "eti") %>% 
  filter(Parameter != "sigma") %>% 
  data.frame() %>%
  dplyr::select(1,3,5,6, 7,8) %>% 
